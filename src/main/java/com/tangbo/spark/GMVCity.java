...
public class GMVCity {
    ...
    public static void main(String[] args) {
        ...
        SparkConf conf = new SparkConf().setAppName("gmv_city")/*.setMaster("local[4]")*/.set("spark.scheduler.pool", "production");
        JavaSparkContext sc = new JavaSparkContext(conf);

        HiveContext sqlContext = new HiveContext(sc);
        // app
        String sql1 = "select tmp.day as day ,tmp.city as city ,tmp.channel as channel_type,\n" +
                "       0 as filter_type, \n" +
                "       0 as platform,\n" +
                "       sum(tmp.cost) as num\n" +
                "       from \n" +
                ...
                "       )tmp group by tmp.day, tmp.city,tmp.channel",
                sql2 = "select  tmp.day as day ,tmp.city as city, tmp.channel as channel_type,\n" +
                        "        2 as filter_type, \n" +
                        "        0 as platform,\n" +
                        "        sum(num) as num\n" +
                        "        from\n" +
                        ...
                        "        and business_order.is_wap = 0 and business_order.distributor_id =0\n" +
                        "        )tmp\n" +
                        "        group by tmp.day, tmp.city, tmp.channel",
                sql3 = "select tmp.day as day ,tmp.city as city,tmp.channel as channel_type, \n" +
                        ...
                        "        )tmp\n" +
                        "        group by tmp.day,tmp.city,tmp.channel",
                sql4 = "select tmp.day as day,tmp.city as city,(tmp.channel+10) as channel_type, \n" +
                        "        0 as filter_type, \n" +
                        "        0 as platform,\n" +
                        ...
                        "        )tmp \n" +
                        "        group by tmp.day,tmp.city,tmp.channel",
                sql5 = "select tmp.day as day,tmp.city as city, (tmp.channel+10) as channel_type,\n" +
                        "        2 as filter_type, \n" +
                        "        0 as platform,\n" +
                        "        sum(num) as num\n" +
                        "        from\n" +
                        ...
                        "        )tmp \n" +
                        "        group by tmp.day,tmp.city,tmp.channel",
                sql6 = "select tmp.day as day,tmp.city as city,(tmp.channel+10) as channel_type,\n" +
                        "        1 as filter_type, \n" +
                        "        0 as platform,\n" +
                        "        count(order_num) as num\n" +
                        "        from\n" +
                        ...
                        "        )tmp\n" +
                        "        group by tmp.day,tmp.city,tmp.channel",
                sql7 = "select  tmp.day as day, tmp.city as city,20 as channel_type,\n" +
                        "        0 as filter_type, \n" +
                        "        0 as platform, \n" +
                        "        sum(tmp.cost) as num \n" +
                        "        from \n" +
                        ...
                        "        and business_order.is_wap = 0 and business_order.distributor_id =0\n" +
                        "        )tmp    group by tmp.day, tmp.city",
                sql8 = "select  tmp.day as day, tmp.city as city,20 as channel_type, \n" +
                        "         2 as filter_type,\n" +
                        "         0 as platform,\n" +
                        "        sum(num) as num\n" +
                        "        from\n" +
                        ...
                        "        and business_order.is_wap = 0 and business_order.distributor_id =0\n" +
                        "        )tmp \n" +
                        "        group by tmp.day, tmp.city",
                sql9 = "select  tmp.day as day, tmp.city as city,20 as channel_type,\n" +
                        "        1 as filter_type, \n" +
                        "        0 as platform,\n" +
                        "        count(order_num) as num\n" +
                        "        from\n" +
                ...
                // h5
                sql10 = "select  tmp.day as day, tmp.city as city,tmp.channel as channel_type,\n" +
                        "        0 as filter_type, \n" +
                        "        1 as platform,\n" +
                        "        sum(total_cost) as num\n" +
                        "        from\n" +
                        ...
                        "        )tmp\n" +
                        "         group by tmp.day, tmp.city,tmp.channel",
                sql11 = " select  tmp.day as day, tmp.city as city,tmp.channel as channel_type,\n" +
                        "        2 as filter_type, \n" +
                        "        1 as platform,\n" +
                        "        sum(num) as num\n" +
                        "        from\n" +
                ...
                sql12 = " select  tmp.day as day, tmp.city as city,tmp.channel as channel_type,\n" +
                        "         1 as filter_type, \n" +
                        "         1 as platform,\n" +
                        "        count(order_num) as num\n" +
                        "        from\n" +
                        ...
                        "        )tmp\n" +
                        "         group by tmp.day, tmp.city,tmp.channel",
                sql13 = "select  tmp.day as day, tmp.city as city,(tmp.channel+10) as channel_type,\n" +
                        "        0 as filter_type, \n" +
                        "        1 as platform,\n" +
                        "        sum(total_cost) as num\n" +
                        "        from\n" +
                        ...
                        "        )tmp \n" +
                        "        group by tmp.day, tmp.city,tmp.channel",
                sql14 = "select  tmp.day as day, tmp.city as city,(tmp.channel+10) as channel_type,\n" +
                        "         2 as filter_type, \n" +
                        "         1 as platform,\n" +
                        "        sum(num) as num\n" +
                        "        from\n" +
                        ...
                        "        )tmp\n" +
                        "        group by tmp.day, tmp.city,tmp.channel",
                sql15 = "select  tmp.day as day, tmp.city as city,(tmp.channel+10) as channel_type,\n" +
                        "         1 as filter_type, \n" +
                        "         1 as platform,\n" +
                        "        count(order_num) as num\n" +
                        "        from\n" +
                ...
                sql16 = "select  tmp.day as day, tmp.city as city,20 as channel_type,\n" +
                        "        0 as filter_type, \n" +
                        "        1 as platform,\n" +
                        "        sum(total_cost) as num\n" +
                        "        from\n" +
                        ...
                        "        )tmp \n" +
                        "        group by tmp.day, tmp.city",
                sql17 = "select  tmp.day as day, tmp.city as city,20 as channel_type,\n" +
                        "        2 as filter_type, \n" +
                        "        1 as platform,\n" +
                        "        sum(num) as num\n" +
                        "        from\n" +
                        ...
                        "        )tmp\n" +
                        "        group by tmp.day, tmp.city",
                sql18 = "select  tmp.day as day, tmp.city as city,20 as channel_type,\n" +
                        "         1 as filter_type, \n" +
                        "         0 as platform,\n" +
                        "        count(order_num) as num\n" +
                        "        from\n" +
                        ...
                        "        )tmp\n" +
                        "        group by tmp.day, tmp.city",
                sql19 = "select  tmp.day as day, tmp.city as city,0 as channel_type,\n" +
                        "        0 as filter_type,\n" +
                        "        2 as platform,\n" +
                        "        sum(total_cost) as num\n" +
                        "        from\n" +
                        ...
                        "        )tmp\n" +
                        "        group by tmp.day, tmp.city",
                sql20 = "select  tmp.day as day, tmp.city as city,0 as channel_type,\n" +
                        "         2 as filter_type, \n" +
                        "         2 as platform,\n" +
                        "        sum(num) as num\n" +
                        "        from\n" +
                        ...
                        "        )tmp \n" +
                        "        group by tmp.day, tmp.city",
                sql21 = "select  tmp.day as day, tmp.city as city,0 as channel_type,\n" +
                        "          1 as filter_type, \n" +
                        "          2 as platform,\n" +
                        "        count(order_num) as num\n" +
                        "        from\n" +
                        ...
                        "        )tmp\n" +
                        "        group by tmp.day, tmp.city",
                sql22 = "select  tmp.day as day, tmp.city as city,1 as channel_type,\n" +
                        "        0 as filter_type,\n" +
                        "        2 as platform,\n" +
                        "        sum(total_cost) as num\n" +
                        "        from\n" +
                        ...
                        "        )tmp\n" +
                        "        group by tmp.day, tmp.city",
                sql23 = "select  tmp.day as day, tmp.city as city,1 as channel_type,\n" +
                        "        2 as filter_type, \n" +
                        "        2 as platform,\n" +
                        "        sum(num) as num\n" +
                        "        from\n" +
                        ...
                        "        )tmp\n" +
                        "        group by tmp.day, tmp.city",
                sql24 = "select  tmp.day as day, tmp.city as city,1 as channel_type,\n" +
                        "        1 as filter_type, \n" +
                        "        2 as platform,\n" +
                        "        count(order_num) as num\n" +
                        "        from\n" +
                        ...
                        "        )tmp\n" +
                        "        group by tmp.day, tmp.city",
                sql25 = "select  tmp.day as day, tmp.city as city,2 as channel_type,\n" +
                        "         0 as filter_type, \n" +
                        "         2 as platform,\n" +
                        "        sum(total_cost) as num\n" +
                        "        from\n" +
                        ...
                        "        )tmp \n" +
                        "        group by tmp.day, tmp.city",
                sql26 = "select  tmp.day as day, tmp.city as city,2 as channel_type,\n" +
                        "         2 as filter_type, \n" +
                        "         2 as platform,\n" +
                        "        sum(num) as num\n" +
                        "        from\n" +
                        ...
                        "        )tmp\n" +
                        "        group by tmp.day, tmp.city",
                sql27 = "select  tmp.day as day, tmp.city as city,2 as channel_type,\n" +
                        "        1 as filter_type, \n" +
                        "        2 as platform,\n" +
                        "        count(order_num) as num\n" +
                        "        from\n" +
        ...
        hiveRDD1.union(hiveRDD2)
                ...
                .union(hiveRDD25)
                .union(hiveRDD26)
                .union(hiveRDD27).map(GMVCity::getRowContent2)
//        .collect().forEach(System.out::println);
    ...
    public static String getRowContent2(Row row) {
        int day = getIntValue(row.get(0));
        int city = getIntValue(row.get(1));
        ...
        return day + SPE + city + SPE + channelType + SPE + filterType + SPE + platform + SPE + num;
    }
